...
const Footer = () => {
  return (
    <footer className="border-t border-gray-600 ">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-4 align-center items-center lg:py-3">
        {/* <div className="md:flex align-center items-center  md:justify-between ">
        ...
        <div className=" mt-2 align-end item-end text-center mb-4">
